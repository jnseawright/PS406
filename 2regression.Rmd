...
---
![image](images/luputitleauthor.JPG){width="4in"}

---
![image](images/lupu1.JPG){width="4in"}

---
![image](images/lupu2.JPG){width="4in"}

---
![image](images/lupu3.JPG){width="4in"}

---
![image](images/lupu4.JPG){width="3in"}
---
...
---
```{r, echo = FALSE, out.width="90%", fig.retina = 1}
include_graphics("htcolonial.png")
```
