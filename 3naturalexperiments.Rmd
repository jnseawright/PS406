...
-   Can Maimonides' Rule be manipulated? What would manipulation look like here?
...
---
### Visualizing Parallel Trends: A Simulation
...
```{r synth_plot_1, echo = TRUE, eval = TRUE}
# Plot the results
...
```{r synth_plot_2, echo = TRUE, eval = TRUE}
# Examine weights
...
```{r synth_plot_3, echo = TRUE, eval = TRUE}
# Check balance
