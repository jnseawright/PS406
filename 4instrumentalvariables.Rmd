...
1\. **Coefficient on endogenous variable**: `gdp_g` = 0.064 — a 1 percentage point increase in growth increases conflict probability by 6.4 points
...
-   The ATE estimate for the effect of anger on outsider voting is `r round(exp.reweight$coefficients[3], 3)`.
...
| ATE (ICSW) | `r round(exp.reweight$coefficients[3], 4)` | Effect for the entire population, assuming the compliance score model is correct. |
