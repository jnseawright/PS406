...
The DWH test fails to reject the null that `gdp_g` is exogenous (p = `r round(summary(dwh_model)$coefficients["first_stage_resid", "Pr(>|t|)"], 2)`).
...
-   The estimated compliance rate is `r round(compliance_rate, 3)`.  
    Being in the treatment group increases the probability of feeling anger by about `r round(compliance_rate*100, 1)` percentage points.
