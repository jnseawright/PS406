...
- **Interpretation**: California's policy change may have decreased the organ donation rate by approximately `r round(100*coef(clfe)["Treated"], 2)` percentage points relative to what would have happened without the policy, under the parallel trends assumption.
