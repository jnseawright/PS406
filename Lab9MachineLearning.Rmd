...
Load King and Zeng’s massive dataset on possible predictors of state collapse, kingzeng.csv. The [website for these data](https://dataverse.harvard.edu/dataset.xhtml?persistentId=hdl:
