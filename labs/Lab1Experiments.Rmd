...
[Submit your lab here.](https://canvas.northwestern.edu/courses/251621/assignments/1730773)
...
###Problem 3: Population Inference (Optional Challenge)

Using the generalize package, assess how well the experimental sample represents the target population (use Census data or simulated population). Estimate the population average treatment effect (PATE) and compare it to the sample ATE.