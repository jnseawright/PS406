...
Suppose the exclusion restriction is violated because rainfall affects conflict through channels other than growth (e.g., agricultural livelihoods directly affect grievances). Use iv.sensemakr to assess how strong a direct effect of rainfall on conflict would need to undermine your confidence in your IV estimate.
